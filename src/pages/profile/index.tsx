      ...
      <div className="sm:w-[350px] w-full border-r bg-bgChatList dark:border-none dark:bg-gray-800">
        <div className="mx-[20px]">
          ...
          <div className="mt-[50px] relative">
            <div className="absolute rounded top-[-8px] left-[10px] bg-bgChatList dark:bg-gray-800 text-blueItem dark:text-white px-[5px]">
              Name
            </div>
            <input
          ...
          <div>
            <button className="mt-[20px] float-right border border-sky-500 px-5 font-bold py-2 text-allChats text-blueItem dark:text-white  hover:bg-blue-100 dark:hover:bg-gray-500 dark:text-white rounded-md">
              Save
            </button>
          </div>
        </div>
