...
export const ItemFriendRequest = (props: Props) => {
  ...
  const handleAddFriend = () => {
    ...
    FriendServices.addFriend(payload)
      ...
      .catch((err) => {
        console.log(err);
        toast.error("Adding friends failed");
      });
  };
    ...
    >
      ...
      <div className="flex justify-end flex-auto text-timeMassage mr-[25px]">
        <button
          ...
          className="flex items-center rounded-xl bg-active hover:bg-blue-500 justify-centerrounded-xl text-white px-2 sm:px-4 py-2 flex-shrink-0"
        >
